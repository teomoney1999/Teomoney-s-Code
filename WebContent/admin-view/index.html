                    ...
                    <div class="sidebar-container">
                        ...
                        <nav class="menu">
                            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                ...
                                <li>
                                    <a href="">
                                        <i class="fa fa-th-large"></i> User Manager <i class="fa arrow"></i>
                                    </a>
                                    <ul class="sidebar-nav">
                                        <li>
                                            <a href="teacher-list.html"> TeacherList </a>
                                        </li>
                                        <li>
                                            <a href="center-list.html"> Center List </a>
                                        </li>
                                        <li>
                                            <a href="rescruiment-list.html"> Recruiment List </a>
                                        </li>
                                        <li>
                                            <a href="item-editor.html"> Send Notify </a>
                                        </li>
                                    </ul>
                                </li>
                                        ...
                                        <div class="row row-sm stats-container">
                                            ...
                                            <div class="col-12 col-sm-6  stat-col">
                                                ...
                                                <div class="stat">
                                                    ...
                                                    <div class="name"> Teacher users </div>
                                                </div>
                                                <div class="progress stat-progress">
                                            ...
                                            <div class="col-12 col-sm-6  stat-col">
                                                ...
                                                <div class="stat">
                                                    <div class="value"> 359 </div>
                                                    <div class="name"> Center users </div>
                                                </div>
                                                <div class="progress stat-progress">
                                                    <div class="progress-bar" style="width: 34%;"></div>
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-6  stat-col">
                                                ...
                                                <div class="stat">
                                                    <div class="value"> 359 </div>
                                                    <div class="name"> Admin users </div>
                                                </div>
                                                <div class="progress stat-progress">
                                                    <div class="progress-bar" style="width: 34%;"></div>
                                                </div>
