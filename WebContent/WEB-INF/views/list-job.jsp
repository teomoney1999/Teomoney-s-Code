  ...
  <div class="site-wrap">
    ...
    <div class="unit-5 overlay" style="background-image: url('images/hero_1.jpg');">
        <div class="container text-center">
            ...
            <p class="mb-0 unit-6"><a href="index.html">Home</a> <span class="sep">></span> <span>Job Lists</span></p>
        </div>
    </div>
    ...
    <section class='list-job'>
        <div class='container list-job-container'>
            <div class='row search-engine'>
                <form action='#'>
                    <input class='search-input' type='text' placeholder="Use keyword such as Skill, Job Tilte, Company">
                    <div class='location'>
                        <select>
            ...
            <div class='row job-list'>
                <div class='col-md-9 list-col'>
                    <h2 class='title'>1000 jobs are waiting for you</h2>
                    <!-- -->
                    <div class='list'>
                        <div class="card">
                            <div class="row ">
