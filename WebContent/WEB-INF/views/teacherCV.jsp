      ...
      <section class='cv-header'>
        <div class='container cv-header-container'>
            <div class='row cv-header-row'>
                ...
                <a class='sign-out' href='#'><button type='signout' class='signout-btn active'>Sign Out</button></a>
            ...
            <div class='row cv-row'>
                ...
                <div class='col-md-4 info'>
                    ...
                    <div class='info-part'>
                        ...
                        <p class='info-value'>${detailInfo.birthDate}</p>
                    </div>
                    <div class='info-part'>
                        <h2 class='info-key'>Address</h2>
                        <p class='info-value'>${detailInfo.address}</p>
                    </div>
                    <div class='info-part'>
        ...
        <div class='container section-container'>
            <div class='row cv-row'>
                ...
                <div class='col-md-4 info'>
                    ...
                    <div class='info-part'>
                        <h2 class='info-key'>Two Authentication Protection</h2>
